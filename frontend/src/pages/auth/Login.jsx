...
export default function Login() {
	...
	const [csrfmiddlewaretoken, setCsrfmiddlewaretoken] = useState(
		'JswHLk4fNpxHkh0OObD1uKiOxSDUzkMDWtqzcsFR5pRdRfYEbNNs1AD23Hkjm2fb'
	)
	...
	const HandlerLogin = async () => {
		await axios
			.post(
				'https://api.talentpost.ru/api/v1/login',
				{
					email,
					password,
					csrfmiddlewaretoken,
	...
	return (
		<>
			...
			<form action="" method="POST">
				...
				<button className="auth__button" type="button" onClick={HandlerLogin}>
					Войти
				</button>
			</form>
		</>
